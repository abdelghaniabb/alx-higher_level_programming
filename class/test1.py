class Animal:
    ...
    def __str__(self):
        return "A {} is {} it is {} ir is {}".format(type(self).__name__, self.birthType, self.appearance, self.blooded)
...
class Mammal(Animal):
    ...
    def __str__(self):
        return super().__str__() + " and it is {} nurse their young".format(self.nurseYoung)
